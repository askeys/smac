/*This code is a modification of pca.c by F. Murtagh.  Modifications:
 1) Replaced main with void function call
 2) Commented out print statements
 See README.txt
*/
...
void pca(float* x, int n, int m, char option)
{
	int  i, j, k, k2;
